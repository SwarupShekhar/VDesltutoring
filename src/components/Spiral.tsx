...
export function Spiral(props: SpiralProps) {
    ...
    useEffect(() => {
        ...
        for (let i = 0; i < totalDots; i++) {
            ...
            // Default opacity for static (although we are dynamic here, setting base opacity)
    ...
    }, [totalDots, dotRadius, duration, dotColor, backgroundColor, margin, minOpacity, maxOpacity, minScale, maxScale, useMultipleColors, colors]);
